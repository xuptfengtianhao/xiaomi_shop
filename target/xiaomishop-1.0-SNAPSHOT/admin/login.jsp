			...
			<div id="bottom">
				<form  action="${pageContext.request.contextPath}/admin/login.action" method="post">
					<table border="0px" id="table">
						<tr>
							<td class="td1">用户名：</td>
							<td><input type="text" value="fth" placeholder="Username" class="td2" name="name"></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							<td class="td1">密码：</td>
							<td><input type="password"  value="5201314" placeholder="Password" class="td2" name="pwd"></td>
						</tr>
						<tr>
							<td></td>
